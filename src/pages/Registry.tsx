...
const Registry = () => {
  return (
    <Wrapper>
      <RegistryItem
        href="http://www.etsy.com/registry/MjIzOTY4MzN8NjA4MTEwNDA/"
        title="See our registry on Etsy"
      >
        <svg width="125" height="125" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24">
          <path
      ...
      <RegistryItem href="http://tgt.gifts/cat-town" title="See our registry at Target">
        <svg
          width="125"
          height="125"
          viewBox="0 0 24 24"
